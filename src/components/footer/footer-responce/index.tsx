...
function FooterResponsive() {
    return (<div className="mt-8 border-t">
        ...
        <div className='mb-24'>
            <div>
                <details className='mr-7'>
                    <summary className="list-none"><h1 className="inline-block my-2 cursor-default text-sm font-bold text-zinc-900">با دیجی کالا <ExpandMoreIcon /></h1></summary>
                    <p className='text-zinc-500 my-3 text-sm cursor-default'>اتاق خبر دیجی‌کالا</p>
                    <p className='text-zinc-500 my-3 text-sm cursor-default'>فروش در دیجی‌کالا</p>
                    <p className='text-zinc-500 my-3 text-sm cursor-default'>فرصت‌های شغلی</p>
                    <p className='text-zinc-500 my-3 text-sm cursor-default'>گزارش تخلف در دیجی‌کالا</p>
                    <p className='text-zinc-500 my-3 text-sm cursor-default'>تماس با دیجی‌کالا</p>
                    <p className='text-zinc-500 my-3 text-sm cursor-default'>درباره دیجی‌کالا</p>
                </details>
                <hr className="border-zinc-300 w-[90%] mx-auto" />
            </div>
            <div>
                <details className='mr-7'>
                    <summary className="list-none"><h1 className="inline-block my-2 cursor-default text-sm font-bold text-zinc-900">خدمات مشتریان <ExpandMoreIcon /></h1></summary>
                    <p className='text-zinc-500 my-3 text-sm cursor-default'>پاسخ به پرسش‌های متداول </p>
                    <p className='text-zinc-500 my-3 text-sm cursor-default'>رویه‌های بازگرداندن کالا </p>
                    <p className='text-zinc-500 my-3 text-sm cursor-default'>شرایط استفاده</p>
                    <p className='text-zinc-500 my-3 text-sm cursor-default'>حریم خصوصی</p>
                    <p className='text-zinc-500 my-3 text-sm cursor-default'>گزارش باگ</p>
                </details>
                <hr className="border-zinc-300 w-[90%] mx-auto" />
            </div>
            <div>
                <details className='mr-7'>
                    <summary className="list-none"><h1 className="inline-block my-2 cursor-default text-sm font-bold text-zinc-900">راهنمای خرید از دیجی‌کالا<ExpandMoreIcon /></h1></summary>
                    <p className='text-zinc-500 my-3 text-sm cursor-default'>نحوه ثبت سفارش</p>
                    <p className='text-zinc-500 my-3 text-sm cursor-default'>رویه ارسال سفارش</p>
                    <p className='text-zinc-500 my-3 text-sm cursor-default'>شیوه‌های پرداخت</p>
                </details>
                <hr className="border-zinc-300 w-[90%] mx-auto" />
            </div>
            <div className='px-8 inline-block mt-4'>
                <h1 className='text-sm text-zinc-700 mb-2'><b>فروشگاه اینترنتی دیجی‌کالا، بررسی، انتخاب و خرید آنلاین
                </b></h1>
                <div className='text-xs text-zinc-500 leading-6'>
                    ...
                    <details>
                        ...
                        <p>    مشتریان خود برساند و ضمانت بازگشت کالا هم داشته باشد؛ ویژگی‌هایی که فروشگاه
