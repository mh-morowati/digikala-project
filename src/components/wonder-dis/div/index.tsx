...
const DivDiscount: React.FC<ChildProps> = ({ imageSrc, productName, discount, count, numDiscount }: ChildProps) => {
  return (<div className="w-[148px] h-[238px] bg-white rounded mx-1 inline-block text-center cursor-pointer ">
    <div>
